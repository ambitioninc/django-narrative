...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Datum.log_level'
        db.add_column(u'narrative_datum', 'log_level',
                      self.gf('django.db.models.fields.IntegerField')(default=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Datum.log_level'
        db.delete_column(u'narrative_datum', 'log_level')
    ...
    models = {
        ...
        u'narrative.datum': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'log_level': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
