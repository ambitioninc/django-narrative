...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'IssueResolutionStep'
        db.create_table('narrative_issueresolutionstep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('narrative', ['IssueResolutionStep'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'IssueResolutionStep'
        db.delete_table('narrative_issueresolutionstep')
    ...
    models = {
        ...
        'narrative.issueresolutionstep': {
            'Meta': {'object_name': 'IssueResolutionStep'},
