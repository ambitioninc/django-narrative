...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'narrative_narrativeconfig', (
            ...
            ('minimum_datum_log_level', self.gf('django.db.models.fields.IntegerField')(default=2)),
        ))
        db.send_create_signal(u'narrative', ['NarrativeConfig'])


    def backwards(self, orm):
        # Deleting model 'NarrativeConfig'
        db.delete_table(u'narrative_narrativeconfig')
    ...
    models = {
        ...
        u'narrative.datum': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'log_level': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
