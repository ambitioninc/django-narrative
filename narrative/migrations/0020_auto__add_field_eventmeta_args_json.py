...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EventMeta.args_json'
        db.add_column(u'narrative_eventmeta', 'args_json',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EventMeta.args_json'
        db.delete_column(u'narrative_eventmeta', 'args_json')
