...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssertionMeta.class_load_path'
        db.add_column('narrative_assertionmeta', 'class_load_path',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssertionMeta.class_load_path'
        db.delete_column('narrative_assertionmeta', 'class_load_path')
