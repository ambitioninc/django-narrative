...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Datum', fields ['timestamp']
        db.create_index(u'narrative_datum', ['timestamp'])


    def backwards(self, orm):
        # Removing index on 'Datum', fields ['timestamp']
        db.delete_index(u'narrative_datum', ['timestamp'])
