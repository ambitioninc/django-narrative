...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Datum'
        db.create_table('narrative_datum', (
            ...
            ('datum_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('datum_note_json', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('thread_id', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ))
        db.send_create_signal('narrative', ['Datum'])


    def backwards(self, orm):
        # Deleting model 'Datum'
        db.delete_table('narrative_datum')
