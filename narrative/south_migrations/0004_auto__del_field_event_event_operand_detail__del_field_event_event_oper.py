...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.event_operand_detail'
        db.delete_column('narrative_event', 'event_operand_detail')

        # Deleting field 'Event.event_operand'
        db.delete_column('narrative_event', 'event_operand')

        # Adding field 'Event.event_details_json'
        db.add_column('narrative_event', 'event_details_json',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.event_operand_detail'
        db.add_column('narrative_event', 'event_operand_detail',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Event.event_operand'
        db.add_column('narrative_event', 'event_operand',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Event.event_details_json'
        db.delete_column('narrative_event', 'event_details_json')
