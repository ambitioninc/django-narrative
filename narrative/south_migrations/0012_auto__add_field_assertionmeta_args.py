...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssertionMeta.args_json'
        db.add_column(u'narrative_assertionmeta', 'args_json',
                      self.gf('django.db.models.fields.TextField')(default='{}', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssertionMeta.args_json'
        db.delete_column(u'narrative_assertionmeta', 'args_json')
