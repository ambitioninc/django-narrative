...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResolutionStep.reason'
        db.add_column(u'narrative_resolutionstep', 'reason',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResolutionStep.reason'
        db.delete_column(u'narrative_resolutionstep', 'reason')
